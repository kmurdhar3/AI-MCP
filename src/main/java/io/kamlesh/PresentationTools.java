...
public class PresentationTools {
    ...
    public PresentationTools() {
        var keynoteOne = new Presentation("Java 24 Launch - Live from JavaOne 2025", "https://www.youtube.com/watch?v=mk_2MIWxLI0", 2020);
        var keynoteTwo = new Presentation("Java Turns 30 - Live from JavaOne 2025", "https://www.youtube.com/watch?v=GwR7Gvi80Xo", 2022);
        ...
        var sequenced = new Presentation("Sequenced Collections - Deep Dive with the Expert","https://www.youtube.com/watch?v=6yuDqkkYTGU",2021);
